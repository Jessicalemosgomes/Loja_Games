...
public class UsuarioControllerTest {
	...
	public void start() {
		...
		LocalDate dataPost = LocalDate.parse("2009-12-22", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        usuario = new Usuario(0L, "Umberto Eco", "umberto@email.com.br", "13465278", dataPost);
        
		LocalDate dataPut = LocalDate.parse("2000-07-22", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        usuarioUpdate = new Usuario(2L, "Joao Ubaldo Ribeiro", "joao@email.com.br", "ubaldo123", dataPut);
	}
